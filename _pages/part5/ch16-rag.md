...
![端到端 RAG 架构。离线流水线（蓝色）对文档进行一次性索引；在线流水线（绿色/橙色）在推理时为每个查询提供服务。](/figures/fig_050_rag_arch.png)
...
![智能体 RAG 控制流。Agent 在返回答案前迭代地进行规划、检索、判断充分性，并自检接地性。](/figures/fig_051_agentic_rag.png)
